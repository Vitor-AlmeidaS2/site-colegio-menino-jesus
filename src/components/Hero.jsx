...
const heroStyle = {
  backgroundImage: `linear-gradient(to right, rgba(45, 20, 55, 0.66) 0%, rgba(70, 35, 80, 0.4) 45%, rgba(70, 35, 70, 0.12) 100%), linear-gradient(rgba(255, 168, 79, 0.14), rgba(255, 150, 60, 0.1)), url(${asset('/hero.jpg')})`
};
